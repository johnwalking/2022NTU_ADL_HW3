...
def parse_args():
    ...
    # Sanity checks
    if args.dataset_name is None and  args.test_file is None and args.train_file is None and args.validation_file is None:
        raise ValueError("Need either a dataset name or a test/training/validation file.")
    else:
    ...
    for epoch in range(1):
        ...
        for step, batch in enumerate(test_dataloader):
            with torch.no_grad():
                ...
                #print("predict: ", decoded_preds, len(decoded_preds))
